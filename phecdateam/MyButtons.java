...
public class MyButtons extends Gui
{
    ...
    public int Color;
    public MyButtons(int buttonId, int x, int y, String buttonText, int Color)
    {
        this(buttonId, x, y, 200, 20, buttonText, Color);
    }

    public MyButtons(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, int Color)
    {
        this.width = 200;
        this.height = 20;
        this.enabled = true;
