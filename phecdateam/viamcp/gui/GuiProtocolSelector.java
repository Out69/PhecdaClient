package pl.oucik.phecdateam.viamcp.gui;
...
import pl.oucik.phecdateam.viamcp.protocols.ProtocolCollection;
...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.BOLD + "Version Changer", this.width / 4, 6, OpenGlHelper.rainbowColor(3000, 1));
        GL11.glPopMatrix();
        drawString(this.fontRendererObj, "ViaMCP: https://github.com/LaVache-FR/ViaMCP", 3, this.height - 10, -1);
